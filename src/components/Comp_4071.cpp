...
nts::Comp_4071::Comp_4071()
{
    nts::Factory factory;
    
    for (size_t i = 0; i < 4; i++) {
        _gates.push_back(factory.createComponent("or", "-1"));
    }
}
...
nts::Tristate nts::Comp_4071::compute(std::size_t pin)
{
...
void nts::Comp_4071::setLink(std::size_t pin, nts::IComponent &other, std::size_t otherPin)
{
    if ((pin - 1) > 13) {
...
void nts::Comp_4071::dump() const
{
    std::cout << "Comp_4071" << std::endl;
    for (size_t i = 0; i < 4; i++) {
...
nts::Tristate nts::Comp_4071::getValue() const
{
    return nts::UNDEFINED;
}

void nts::Comp_4071::setValue(std::string const &)
{
}