...
nts::Comp_4001::Comp_4001()
{
    nts::Factory factory;
    
    for (size_t i = 0; i < 4; i++) {
        _gates.push_back(factory.createComponent("nor", "-1"));
    }
}
...
nts::Tristate nts::Comp_4001::compute(std::size_t pin)
{
...
void nts::Comp_4001::setLink(std::size_t pin, nts::IComponent &other, std::size_t otherPin)
{
    if ((pin - 1) > 13) {
...
void nts::Comp_4001::dump() const
{
    std::cout << "Comp_4001" << std::endl;
    for (size_t i = 0; i < 4; i++) {
...
nts::Tristate nts::Comp_4001::getValue() const
{
    return nts::UNDEFINED;
}

void nts::Comp_4001::setValue(std::string const &)
{
}