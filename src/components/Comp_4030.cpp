...
nts::Comp_4030::Comp_4030()
{
    nts::Factory factory;
    
    for (size_t i = 0; i < 4; i++) {
        _gates.push_back(factory.createComponent("xor", "-1"));
    }
}
...
nts::Tristate nts::Comp_4030::compute(std::size_t pin)
{
...
void nts::Comp_4030::setLink(std::size_t pin, nts::IComponent &other, std::size_t otherPin)
{
    if ((pin - 1) > 13) {
...
void nts::Comp_4030::dump() const
{
    std::cout << "Comp_4030" << std::endl;
    for (size_t i = 0; i < 4; i++) {
...
nts::Tristate nts::Comp_4030::getValue() const
{
    return nts::UNDEFINED;
}

void nts::Comp_4030::setValue(std::string const &)
{
}